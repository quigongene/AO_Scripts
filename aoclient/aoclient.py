...
class AOClient(object):
    def __init__(self):
        ...
        self.private_key, self.public_key = _make_keys()
    ...
    def authenticate(self, username, password):
        token = _make_login_token(self.server_seed, username, password)
